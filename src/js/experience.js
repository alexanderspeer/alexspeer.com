    ...
    education: [
        {
            ...
            details: [
                ...
                "<strong>Relevant coursework includes:</strong><ul><li>Brain-Computer Interfaces Lab</li><li>Computational Neuroscience: Circuits in the Brain</li><li>Signals and Systems</li><li>Applied Machine Learning</li><li>Deep Learning and Computer Vision</li><li>Computational Neuroscience</li><li>Electrical Engineering</li><li>Mathematical Foundations for Generative AI</li><li>Machine Intelligence</li><li>Calculus-Based Statistics</li><li>Cognitive Neuroscience</li><li>Neuroscience</li><li>Social Neuroscience</li><li>Cognitive Science</li><li>Natural Language Processing</li></ul>"
            ]
        }
    ],
    work_experience: [
